...
public class TimeManager: MonoBehaviour
{
    ...
    [SerializeField] internal float durationPreAnimateChosenCardTick = 0.1f; // длительность 1го тика анимации выбранной карты, когда карта перед итоговым показом несколько раз скейлится туда-обратно
